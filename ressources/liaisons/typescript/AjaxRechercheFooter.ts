...
export class AjaxRechercheFooter {
    ...
    constructor() {
        ...
        this.selectCritere = $("#critereFooter");
        this.inputRecherche = $("#mot_cleFooter");
    ...
    public retournerResultat(data) {
        let resultat: JQuery<HTMLElement> = $('#rechercheResultatsFooter');
